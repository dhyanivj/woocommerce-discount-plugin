...
class Elex_DP_New_Calculation_Handler {
	...
	public function elex_dp_get_discounted_price_for_product( $old_price = '', $product = null, $pid = null ) {
		...
		/**
		 * Apply filter hook for discount on addon prices
		 * 
		 * @since 1.0.0
		 */

		 /**
		 * Apply filter hook for before calculate totals
		 * 
		 * @since 1.0.0
		 */
	...
	public function elex_dp_get_discounted_price_html_for_group_product( $price, $product ) {
		...
		if ( '' !== $min_price ) {
			...
			if ( $is_free ) {
				/**
				 * Apply filter hook for grouped free price html
				 * 
				 * @since 1.0.0
				 */
				...
				/**
				 * Apply filter hook for grouped price html
				 * 
				 * @since 1.0.0
				 */
			...
			/**
			 * Apply filter hook for grouped empty price html
			 * 
			 * @since 1.0.0
			 */
	...
	public function elex_dp_get_discounted_price_html_for_variable_product( $price, $product ) {
		...
		/**
		 * Apply filter hook for variable sale price html
		 * 
		 * @since 1.0.0
		 */
